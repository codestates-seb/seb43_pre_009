package com.team.SEB_43_pre09.security.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.team.SEB_43_pre09.member.entity.MemberEntity;
import com.team.SEB_43_pre09.security.dto.LoginDto;
...
//        claims.put("memberId", member.getMemberId());  // 식별자도 포함할 수 있다.
    ...
    private String delegateRefreshToken(MemberEntity member) {
        String subject = member.getMemberEmail();
